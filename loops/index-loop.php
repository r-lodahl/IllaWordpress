...
<?php if ( function_exists('illarion_pagination') ) { illarion_pagination(); } else if ( is_paged() ) { ?>
<ul class="pagination">
  <li class="page-item older">
    <?php next_posts_link('<i class="fas fa-arrow-left"></i> ' . __('Previous', 'illarion')) ?></li>
  <li class="page-item newer">
    <?php previous_posts_link(__('Next', 'illarion') . ' <i class="fas fa-arrow-right"></i>') ?></li>
</ul>
<?php } ?>
