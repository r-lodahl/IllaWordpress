...
if ( ! function_exists( 'illarion_pagination' ) ) {
	function illarion_pagination() {
		global $wp_query;
		...
		$paginate_links = paginate_links( array(
			...
			'mid_size' => 5,
			'prev_next' => True,
			'prev_text' => __('<i class="fas fa-angle-left"></i> Newer', 'illarion'),
			'next_text' => __('Older <i class="fas fa-angle-right"></i>', 'illarion'),
			'type' => 'list'
		) );
